...
LangSmith provides observability for LangChain/LangGraph applications, offering tracing, evaluation, and monitoring capabilities.
    ...
    store = InMemoryStore() # temporary, non‑persistent storage inside your Python process that holds documents, directly in memory instead of in a database or external vector store.
                            # It’s basically a RAM‑based storage layer used for fast prototyping, testing, and small RAG systems.
